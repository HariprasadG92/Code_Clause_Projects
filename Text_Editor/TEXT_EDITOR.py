...
statbarb = Label(root, text="Ln", relief=RAISED, bd=1, anchor="w")
...
def about():
    showinfo("About Text_Editor","This is a TEXT EDITOR PROJECT built using Tkinter GUI\nDeveloped by Hariprasad G\nGithub:")
def exitapplication():
    root.quit()
def selectall():
    global textarea
